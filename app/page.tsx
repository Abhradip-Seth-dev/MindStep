    ...
    <div ref={containerRef} style={{
      ...
      <motion.section style={{ y: heroY, opacity: heroOpacity }}>
        <div style={{
          ...
          textAlign: 'center', padding: '140px 40px 80px',
          position: 'relative', zIndex: 1,
        }}>

          {/* Badge */}
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
            style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 18px', borderRadius: 20, marginBottom: 48, background: 'rgba(79,195,161,0.06)', border: '1px solid rgba(79,195,161,0.18)' }}
          >
            <motion.div animate={{ scale: [1, 1.5, 1] }} transition={{ duration: 2, repeat: Infinity }}
              style={{ width: 6, height: 6, borderRadius: '50%', background: '#4FC3A1', boxShadow: '0 0 8px #4FC3A1' }} />
            <span style={{ fontSize: 12, color: '#4FC3A1', fontWeight: 500, letterSpacing: '0.05em' }}>
              Campus Mental Health Intelligence · The Neotia University
            </span>
          </motion.div>
          ...
          <div style={{ position: 'relative', marginBottom: 28 }}>
            <motion.h1
              ...
              style={{ fontSize: 'clamp(56px, 9vw, 108px)', fontFamily: 'Playfair Display, serif', fontWeight: 700, lineHeight: 0.95, letterSpacing: '-0.03em', margin: 0 }}
            >
            ...
            <motion.div
              ...
              style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: 400, height: 200, borderRadius: '50%', background: 'radial-gradient(ellipse, rgba(79,195,161,0.15) 0%, transparent 70%)', filter: 'blur(40px)', pointerEvents: 'none', zIndex: -1 }}
            />
          </div>

          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}
            style={{ fontSize: 22, color: '#4A5A6E', lineHeight: 1.6, maxWidth: 520, marginBottom: 8 }}>
            You just can't see it yet.
          </motion.p>

          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}
            style={{ fontSize: 15, color: '#3A4A5E', lineHeight: 1.9, maxWidth: 460, marginBottom: 52 }}>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }}
            style={{ display: 'flex', gap: 14, alignItems: 'center', marginBottom: 64, flexWrap: 'wrap', justifyContent: 'center' }}
          >
            <motion.button
              whileHover={{ scale: 1.04, boxShadow: '0 16px 48px rgba(79,195,161,0.45)' }}
              whileTap={{ scale: 0.97 }}
              onClick={() => router.push('/onboarding')}
              style={{ padding: '18px 44px', borderRadius: 16, border: 'none', background: 'linear-gradient(135deg, #4FC3A1, #3DA88B)', color: '#080C12', fontSize: 16, fontWeight: 700, cursor: 'none', fontFamily: 'Inter, sans-serif', boxShadow: '0 8px 32px rgba(79,195,161,0.3)', letterSpacing: '-0.01em' }}
            >
              Start your journey →
            </motion.button>
            <motion.button
              whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
              onClick={() => router.push('/login')}
              style={{ padding: '18px 36px', borderRadius: 16, background: 'transparent', border: '1px solid rgba(255,255,255,0.1)', color: '#5A6A7E', fontSize: 15, cursor: 'none', fontFamily: 'Inter, sans-serif' }}
            >
              Sign in
            </motion.button>
            <motion.button
          ...
          >
            <div style={{ height: 1, width: 50, background: 'linear-gradient(90deg, transparent, rgba(255,255,255,0.1))' }} />
            ...
            <AnimatePresence mode="wait">
              <motion.span key={currentWord}
                ...
                style={{ fontSize: 14, color: '#4FC3A1', fontFamily: 'Playfair Display, serif', fontStyle: 'italic', minWidth: 100, textAlign: 'center' }}
              >
                {FLOATING_WORDS[currentWord]}
              </motion.span>
            </AnimatePresence>
            <span style={{ fontSize: 11, color: '#2A3547', letterSpacing: '0.2em', textTransform: 'uppercase' }}>daily</span>
            <div style={{ height: 1, width: 50, background: 'linear-gradient(90deg, rgba(255,255,255,0.1), transparent)' }} />
          </motion.div>
              ...
              <div style={{ padding: '20px 20px 8px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                  <div>
                    ...
                    <p style={{ fontSize: 18, fontFamily: 'Playfair Display, serif', color: '#E8EEF5' }}>
                      Abhradip, <span style={{ color: '#4FC3A1' }}>you're stable</span>
                    </p>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '6px 14px', borderRadius: 20, background: 'rgba(79,195,161,0.1)', border: '1px solid rgba(79,195,161,0.2)' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12, marginBottom: 14 }}>
                  {[
                    ...
                    <motion.div key={i}
                      ...
                      style={{ padding: '14px', borderRadius: 14, background: `${card.color}08`, border: `1px solid ${card.color}18` }}
                    >
                      ...
                      <p style={{ fontSize: 26, fontWeight: 300, fontFamily: 'Playfair Display, serif', color: card.color, lineHeight: 1, marginBottom: 4 }}>{card.value}</p>
      ...
      {/* STATS */}
      <section style={{ padding: '50px 60px', position: 'relative', zIndex: 1, borderTop: '1px solid rgba(255,255,255,0.04)', background: 'rgba(255,255,255,0.015)' }}>
        <div style={{ display: 'flex', justifyContent: 'center', gap: 0, maxWidth: 800, margin: '0 auto' }}>
          {[
            ...
            <motion.div key={i}
              ...
              style={{ flex: 1, textAlign: 'center', padding: '20px', borderRight: i < 3 ? '1px solid rgba(255,255,255,0.06)' : 'none' }}
            >
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, justifyContent: 'center', marginBottom: 6 }}>
                <span style={{ fontSize: 48, fontWeight: 300, fontFamily: 'Playfair Display, serif', color: '#4FC3A1', lineHeight: 1 }}>{stat.value}</span>
                <span style={{ fontSize: 14, color: '#3A4A5E' }}>{stat.unit}</span>
              </div>
      ...
      <section style={{ padding: '120px 60px', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <h2 style={{ fontSize: 56, fontFamily: 'Playfair Display, serif', color: '#E8EEF5', fontWeight: 600, lineHeight: 1.05, marginBottom: 16 }}>Groundbreaking features</h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 2, maxWidth: 1000, margin: '0 auto' }}>
          {FEATURES.map((feature, i) => (
            <motion.div key={i}
              ...
              style={{
                ...
                cursor: 'none', transition: 'all 0.4s', position: 'relative', overflow: 'hidden',
              }}
            >
              {hoveredFeature === i && (
      ...
      <section style={{ padding: '80px 60px 120px', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <h2 style={{ fontSize: 52, fontFamily: 'Playfair Display, serif', color: '#E8EEF5', fontWeight: 600 }}>What they noticed</h2>
        </motion.div>
        ...
        <div style={{ maxWidth: 700, margin: '0 auto', position: 'relative', minHeight: 180 }}>
          <AnimatePresence mode="wait">
            <motion.div key={activeTestimonial}
              ...
              style={{ padding: '48px', borderRadius: 24, background: `linear-gradient(135deg, ${TESTIMONIALS[activeTestimonial].color}08, rgba(255,255,255,0.02))`, border: `1px solid ${TESTIMONIALS[activeTestimonial].color}18`, textAlign: 'center', position: 'relative', overflow: 'hidden' }}
            >
              <div style={{ position: 'absolute', top: 20, left: 32, fontSize: 80, color: `${TESTIMONIALS[activeTestimonial].color}10`, fontFamily: 'Playfair Display, serif', lineHeight: 1, userSelect: 'none' }}>"</div>
              <p style={{ fontSize: 20, fontFamily: 'Playfair Display, serif', color: '#C8D4E0', lineHeight: 1.7, fontStyle: 'italic', marginBottom: 24, position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 8, marginTop: 24 }}>
            {TESTIMONIALS.map((_, i) => (
              <motion.button key={i} onClick={() => setActiveTestimonial(i)}
                ...
                style={{ height: 6, borderRadius: 3, border: 'none', cursor: 'none', background: '#4FC3A1' }}
              />
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: '80px 60px 120px', position: 'relative', zIndex: 1 }}>
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          style={{ maxWidth: 860, margin: '0 auto', textAlign: 'center', padding: '100px 80px', borderRadius: 32, background: 'linear-gradient(135deg, rgba(79,195,161,0.07), rgba(91,156,246,0.04), rgba(167,139,250,0.06))', border: '1px solid rgba(79,195,161,0.12)', position: 'relative', overflow: 'hidden' }}
        >
          ...
          <h2 style={{ fontSize: 60, fontFamily: 'Playfair Display, serif', color: '#E8EEF5', fontWeight: 600, lineHeight: 1.05, marginBottom: 20 }}>
            Start seeing<br />your pattern
          </h2>
          <p style={{ fontSize: 16, color: '#4A5A6E', lineHeight: 1.9, marginBottom: 48, maxWidth: 420, margin: '0 auto 48px' }}>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            onClick={() => router.push('/onboarding')}
            style={{ padding: '20px 56px', borderRadius: 18, border: 'none', background: 'linear-gradient(135deg, #4FC3A1, #3DA88B)', color: '#080C12', fontSize: 18, fontWeight: 700, cursor: 'none', fontFamily: 'Inter, sans-serif', boxShadow: '0 8px 40px rgba(79,195,161,0.35)', display: 'block', margin: '0 auto 20px' }}
          >
      ...
      {/* FOOTER */}
      <footer style={{ padding: '32px 60px', borderTop: '1px solid rgba(255,255,255,0.04)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'relative', zIndex: 1 }}>
        ...
        <p style={{ fontSize: 11, color: '#2A3547' }}>Campus Mental Health Intelligence System</p>
        <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
          {['Privacy', 'About'].map((item) => (
            <button key={item} style={{ background: 'none', border: 'none', color: '#2A3547', fontSize: 11, cursor: 'none', fontFamily: 'Inter, sans-serif', transition: 'color 0.2s' }}
